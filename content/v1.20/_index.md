...
<a href="{{<ref "getting-started">}}" style="padding: 2rem; border-radius: 12px; background: linear-gradient(135deg, rgba(100, 200, 100, 0.05) 0%, rgba(200, 200, 100, 0.05) 100%); border: 2px solid var(--border-color); text-decoration: none; color: var(--body-font-color); display: block; transition: all 0.3s ease; position: relative; overflow: hidden;" onmouseover="this.style.borderColor='var(--content-link-color)'; this.style.boxShadow='0 8px 24px rgba(0,0,0,0.12)';" onmouseout="this.style.borderColor='var(--border-color)'; this.style.boxShadow='none';">
...
Ready to install Crossplane? Follow the [Getting Started guide]({{<ref "getting-started">}}) to set up Crossplane and explore the core concepts.

**Not sure where to begin?** Check [Foundations]({{<ref "foundations">}}) to understand core concepts first.
