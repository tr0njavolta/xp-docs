...
---
{{< hint "important" >}}
**Ready to try Crossplane?** Jump to [Get Started]({{<ref "../get-started">}}) guides to build your first control plane.
    {{< /hint >}}
...
{{< hint "tip" >}}
**A [control plane]({{<ref "control-planes">}}) is software that controls other software.**
...
lifecycle. If your software ever _drifts_ from your [desired state]({{<ref "control-planes">}}), the control
...
Not familiar with Kubernetes [custom resources]({{<ref "custom-resources">}}) and controllers?
[This DevOps Toolkit video](https://www.youtube.com/watch?v=aM2Y9m2Kazk) has a
great explanation, or read the [Custom Resources & CRDs]({{<ref "custom-resources">}}) foundation guide.
...
extend Kubernetes with new [custom resources]({{<ref "custom-resources">}}).
...
Managed resources (MRs) are ready-made Kubernetes [custom resources]({{<ref "custom-resources">}}). 
